...
def DepthwiseSeparableConv(in_channels, out_channels, kernel_size=3, stride=1, padding=1):
    return nn.Sequential(
        nn.Conv2d(in_channels, in_channels, kernel_size, stride, padding, in_channels,False),
        nn.Conv2d(in_channels, out_channels, 1, False),
...
class PixelShuffle(nn.Module):
    def __init__(self, dim, scale):
        ...
        self.upsamle = nn.Sequential(
            ...
            nn.PixelShuffle(scale),     #PixelShuffle的输出通道是dim/(scale**2)
