from model_4.mamba import EncoderMambaBlock
from model_4.transformer import DCTM
from common import *
device_id0 = 'cuda:0'
...
class mamba_Unet(nn.Module):
    ...
    def __init__(self, n_subs, n_mamba, height, width, conv=default_conv):
        ...
        self.step1 = nn.Sequential(
            ...
            DepthwiseSeparableConv(n_subs, n_subs, 3, 1, 1),
        )
...
#         self.step1 = nn.Sequential(
#             EncoderMambaBlock(n_subs, height, width),
#             conv(n_subs, n_subs, 1),
#             nn.LeakyReLU(),
#         )
#         self.step2 = nn.Sequential(
#             Down(n_subs, n_subs * 2),
#             DCTM(n_subs * 2, 6),
#             conv(n_subs * 2, n_subs * 2, 1),
#             nn.LeakyReLU(),
#         )
#         self.step3 = nn.Sequential(
